...
For virtual circumnavigators.

Based on an idea prompted from when my kid was three, who frequently asked me how long it would take to get to the North Pole (or other faraway locations) as I'd pull him around our city in his wagon.
...
The larger, loftier goal I have in mind is not just to measure time and space, but to make virtual circumnavigators fall in love with the Earth.

## Concept

Also inspired by Josh Worth's [If the Moon Were Only 1 Pixel](https://joshworth.com/dev/pixelspace/pixelspace_solarsystem.html), this project aims to create a similar sense of awe and scale — focused on Earth itself, rather than the cosmos.
...
Unless I've utterly broken it, it lives here:
